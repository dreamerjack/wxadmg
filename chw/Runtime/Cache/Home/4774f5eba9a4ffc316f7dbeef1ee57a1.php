...
<form action="<?php echo U(home/login/login);?>" method="POST" enctype="multipart/form-data" onsubmit="return test()"; >
            ...
            <div class="form-group loginForm">
                ...
                <div class="input-group register">
                    <i></i>
                    <input type="password" placeholder="密码" class="form-control"       id="content-pwd" name="pwd" onfocus="this.removeAttribute('readonly')" />
                </div>
...
登录类型：
 <select class="set" name="mansel" id="selectop" >
  <!--
<option value="3">我是分析师</option>
<option  value="2">我是客服</option>
-->
...
-->
                ...
                <img class="yezi" width="96" height="82" title="花镇情感咨询" alt="花镇情感咨询" src="http://tgoss.huazhen2008.com/backend/img/images/yezi.png">
            </div>
        </div>
