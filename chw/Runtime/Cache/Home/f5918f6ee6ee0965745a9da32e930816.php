...
//请求数据结束
  ...
  $.ajax({ 
    ...
    // url : 'http://localhost/ordersystem/chw/index.php/Home/Book/booklist?',
     url : "<?php echo U('home/qqtrade/all_del');?>",
     data:{
...
<?php else: ?>
  ...
  <div class="adduser"><a href="<?php echo U('home/qqtrade/wxadd');?>">新建计划</a></div><?php endif; ?>
 ...
 <td   class="tab-title" ><input name="fid" id="id"  class="box"  type="checkbox" value="<?php echo ($list["id"]); ?>" >   <?php echo ($list["id"]); ?> </td>
                ...
                <td class="tab-title  tab-titlehf " ><a href="<?php echo U('home/qqtrade/planlist',array('planid'=>$list['id'],'navid'=>$list['medium']));?>">管理</a> 
    <!--  <a href="<?php echo U('home/qqtrade/qqtrade_edit',array('planid'=>$list['id'],'navid'=>1));?>">修改</a> -->

          <?php if($competence == 0 ): ?><a  class="delhf" href="<?php echo U('home/qqtrade/qqtrade_del',array('spot_id'=>$list['id'],'navid'=>$list['medium']));?>"  onclick='return del();' >删除</a> 
<?php else: endif; ?>
                </td>
...
<?php if($competence == 0 ): ?><tr>     <td  class="tab-title"  colspan="5" style="padding-left:20px;text-align:left;height:45px;"><input class="checksl"  id="selectAll" type="button"  value="全选" onclick="checkAll()"/>
